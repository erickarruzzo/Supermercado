...
public class ControladorGerente extends ControladorGeral {
	...
	public void printaMenuOpcoes() {
		...
		System.out.println("Digite 3 para visualizar quais funcionários estáo alocados nos caixas");
		...
		System.out.println("Digite 6 para gera um relatório de vendas de um caixa especáfico: ");
